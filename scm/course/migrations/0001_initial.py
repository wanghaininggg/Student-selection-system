    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('courseInstitute', models.ForeignKey(on_delete=django.db.models.fields.CharField, to='management.Institute', verbose_name='所属学院')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selectCourseAllNum', models.IntegerField(verbose_name='课程总人数')),
                ('selectCourseNum', models.IntegerField(verbose_name='已选人数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studentSelectCourse_score', models.CharField(blank=True, max_length=10, null=True, verbose_name='成绩')),
                ...
                ('studentSelectCourse_stduent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.StudentUser', verbose_name='学生学号')),
            ],
            options={
                'verbose_name': '学生选课表',
