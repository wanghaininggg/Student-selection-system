...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Classroom',
            fields=[
                ('classroomID', models.CharField(max_length=20, primary_key=True, serialize=False, verbose_name='教室编号')),
                ('classroomName', models.CharField(choices=[('汇学楼101', '汇学楼101'), ('致远楼205', '致远楼205')], max_length=30, verbose_name='教室名称')),
            ],
            options={
                'verbose_name': '教室',
